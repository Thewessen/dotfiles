...
if &t_Co > 255
    ...
    if &background == 'dark'
      ...
      " TODO: remove when linking can be done
        hi luaTSConstructor ctermfg=102
        hi tsxTSConstructor ctermfg=232
        hi TSProperty ctermfg=232
        hi tsxTSNamespace ctermfg=232
        hi TSField ctermfg=232
        " hi tsxTSType ctermfg=232
        " hi tsxTSParameter ctermfg=232
        hi LspDiagnosticsDefaultHint ctermfg=3
