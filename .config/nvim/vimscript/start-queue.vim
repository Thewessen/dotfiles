...
function! s:custom_list(A,C,P)
  return ['snelberekenen', 'ufo-connect', 'aflosvrij', 'mail', 'signalmail', 'lifeinsurance', 'hypotheekcheck', 'refinancing', 'risk-class-reduction', 'test-fastlane', 'client-deleter', 'legacy']
endfunction
