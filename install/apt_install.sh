...
if [[ -z $(command -v zsh) ]]; then
  echo "ZSH should be installed first!! Aborting!"
    ...
    programs=("xclip" "cmake" "terminator" "tmux" "vim" "npm" "git" "nodejs" "js" "rhino" "haskell-platform" "python3" "python3-dev" "python3.6-dev" "python-dev" "ctags" "ttf-mscorefonts-installer" "fonts-inconsolata")
