# Generated by Powerlevel10k configuration wizard on 2023-01-13 at 14:15 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_RULER_FOREGROUND=233
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%19F'   # blue foreground
      local   modified='%166F'  # yellow foreground
      local  untracked='%240F'   # gray foreground
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=240
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=19
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=240
  ...
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=22
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=166
  # Load color when load is over 70%.
  typeset -g POWERLEVEL9K_LOAD_CRITICAL_FOREGROUND=124
  # Custom icon.
  # typeset -g POWERLEVEL9K_LOAD_VISUAL_IDENTIFIER_EXPANSION='⭐'

  ################[ todo: todo items (https://github.com/todotxt/todo.txt-cli) ]################
  # Todo color.
  typeset -g POWERLEVEL9K_TODO_FOREGROUND=130
